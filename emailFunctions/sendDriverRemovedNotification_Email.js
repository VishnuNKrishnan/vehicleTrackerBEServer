...
<p style="font-size: 11px; font-family: Ubuntu, Helvetica, Arial; text-align: left;"><span style="font-size: 13px; color: rgb(0, 0, 0);">This is to confirm that ${ownerName}'s ${vehicleType}, registered as ${licensePlate} has been returned to the owner and your association with this vehicle has ended.</span></p></div>
    ...
    const msg = {
        ...
        subject: `${vehicleType} returned to owner`,
        text: `
        ...
        ${licensePlate}, has been returned to the owner and your association with this
        vehicle has ended.`,
        html: htmlContent
    }
    sgMail.send(msg)
    console.log(`Driver Removed - ${vehicleType} | ${driverName} - Email sent!`);
    return 'Success'

}

module.exports = { sendDriverRemoved_Email }