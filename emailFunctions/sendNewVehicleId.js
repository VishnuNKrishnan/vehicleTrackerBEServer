...
async function sendNewVehicleId_Email(newVehicleId, toEmailId){
    ...
    * {
    ...
    <!--[if (mso)|(IE)]><td align="center" width="496" style="background-color: #c7d3ac;width: 496px;padding: 0px;border-top: 2px solid #436005;border-left: 2px solid #436005;border-right: 2px solid #436005;border-bottom: 2px solid #436005;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
    <div class="u-col u-col-100" style="max-width: 320px;min-width: 500px;display: table-cell;vertical-align: top;">
      <div style="background-color: #c7d3ac;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
      <!--[if (!mso)&(!IE)]><!--><div style="padding: 0px;border-top: 2px solid #436005;border-left: 2px solid #436005;border-right: 2px solid #436005;border-bottom: 2px solid #436005;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;">Hi! Your new vehicle ID is</p>
      </div>
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%;">Please use this ID to link your vehicle within the next 10 minutes.</p>
      </div>
    ...
    sgMail.send(msg)
    console.log(`New Vehicle ID - ${newVehicleId} - Email sent!`);
    //return 'Success'
}

//sendNewVehicleId_Email('908-jfk-896-ldo')

module.exports = { sendNewVehicleId_Email }